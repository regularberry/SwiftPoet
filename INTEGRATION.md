...
SwiftPoet uses **Swift 3.1** and **requires Xcode 8.3** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/gilt/SwiftPoet/master/Documentation/API/index.html) provided by SwiftPoet in any Swift file using the statement:
