...
**This is the `swift-4` branch of SwiftPoet.** It uses **Swift 4.0** and **requires Xcode 9.0 beta** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/gilt/SwiftPoet/swift-4/Documentation/API/index.html) provided by SwiftPoet in any Swift file using the statement:
...
This specifies that Carthage use the latest version of SwiftPoet that is API-compatible with 0.9.0, i.e. any 0.9.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/gilt/SwiftPoet/releases); there may be a newer version than 0.9.0 that is no longer API-compatible.
...
Want to learn more about SwiftPoet? Check out [the README](https://github.com/gilt/SwiftPoet/blob/swift-4/README.md) or [the API documentation](https://rawgit.com/gilt/SwiftPoet/swift-4/Documentation/API/index.html).
