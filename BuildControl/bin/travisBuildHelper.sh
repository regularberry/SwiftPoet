...
( set -o pipefail && xcodebuild -project SwiftPoet.xcodeproj -configuration Debug -scheme "SwiftPoet" -destination "$DESTINATION" -destination-timeout 300 $BUILD_ACTION 2>&1 | tee "SwiftPoet-$PLATFORM-$OPERATION.log" | xcpretty )
